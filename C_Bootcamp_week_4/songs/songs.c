...
int main()
{
    ...
    {   
        // first we will get the info from the line - EACH INDIVIDUAL LINE IS SPLIT UP
        tokeniseRecord(line,",",pos,artist,title,year); // Splits it up and adds it into those splitted up versions
        // but then what??
        strcpy(songs[counter].artist, artist); // DEST FIRST, THEN SOURCE
